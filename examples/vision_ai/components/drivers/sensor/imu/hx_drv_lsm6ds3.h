#ifndef HX_DRV_LSM6DS3_H
#define HX_DRV_LSM6DS3_H
...
struct SensorSettings
{
    ...
    int16_t fifo_sample_rate;
    uint8_t fifo_mode_word;

    uint16_t temp_sensitivity;
};

typedef struct dev_lsm6ds3
{
    USE_SS_IIC_E i2c;
    uint8_t address;
