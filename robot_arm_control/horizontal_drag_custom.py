...
placeholder_3_label = customtkinter.CTkLabel(canvas_frame,
                                             text="1.Please input the port number (COM) to which the robotic arm is connected to the computer in the 'Input Port' section.",
                                             justify="left",
                                             wraplength=300,
                                             fg_color="transparent")
placeholder_3_label.grid(row=14, column=0, padx=10, pady=10, sticky="w", columnspan=2)

placeholder_4_label = customtkinter.CTkLabel(canvas_frame,
                                             text="2.Then, click the blue 'Connect' button or press the Enter key to establish a connection. Once connected, you will see the status change from 'Disconnected' to 'Connected' next to it.",
                                             justify="left",
                                             wraplength=300,
                                             fg_color="transparent")
placeholder_4_label.grid(row=15, column=0, padx=10, pady=10, sticky="w", columnspan=2)

placeholder_5_label = customtkinter.CTkLabel(
    canvas_frame,
    text="3.After clicking the 'MovingCtrl:Disable' button, the status will change to 'MovingCtrl:Enable'.At this point, you can control the rotation of the robotic arm by moving the mouse in the drawing area on the left.",
    wraplength=300,
    justify="left",
    fg_color="transparent")
placeholder_5_label.grid(row=16, column=0, padx=10, pady=10, sticky="w", columnspan=2)

placeholder_6_label = customtkinter.CTkLabel(canvas_frame,
                                             text="4.Left-click on the mouse in the drawing area to turn on the LED light. Release the left mouse button to turn off the LED light. ",
                                             wraplength=300,
                                             justify="left",
                                             fg_color="transparent")
placeholder_6_label.grid(row=17, column=0, padx=10, pady=10, sticky="w", columnspan=2)

placeholder_7_label = customtkinter.CTkLabel(canvas_frame,
                                             text="5.When you click the left mouse button and move it in the drawing area, it will leave a trace on the interface. Press the spacebar or click 'ClearCanvas' to clear all traces.",
                                             wraplength=300,
                                             justify="left",
                                             fg_color="transparent")
