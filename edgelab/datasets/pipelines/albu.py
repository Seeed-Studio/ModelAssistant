...
class ColorJitter(A.ColorJitter):
    ...
    def __init__(self,
                 ...
                 always_apply=False,
                 p=0.5):
        super().__init__(brightness, contrast, saturation, hue, always_apply,
                         p)
...
class Rotate(A.Rotate):
    ...
    def __init__(self,
                 ...
                 always_apply=False,
                 p=0.5):
        super().__init__(limit, interpolation, border_mode, value, mask_value,
...
class Affine(A.Affine):
    ...
    def __init__(self,
                 ...
                 translate_percent: Optional[Union[float, Sequence[float],
                                                   dict]] = None,
                 translate_px: Optional[Union[int, Sequence[int],
                                              dict]] = None,
                 ...
                 cval_mask: Union[int, float, Sequence[int],
                                  Sequence[float]] = 0,
                 ...
                 p: float = 0.5):
        super().__init__(scale, translate_percent, translate_px, rotate, shear,
                         interpolation, mask_interpolation, cval, cval_mask,
...
class SafeRotate(A.SafeRotate):
    ...
    def __init__(self,
                 ...
                 value=None,
                 mask_value: Optional[Union[int, float, Sequence[int],
                                            Sequence[float]]] = None,
                 always_apply: bool = False,
                 p: float = 0.5):
        super().__init__(limit, interpolation, border_mode, value, mask_value,
