...
class FPN(_FPN):
    ...
    def __init__(
        ...
        init_cfg: Union[Union[ConfigDict, dict],
                        List[Union[ConfigDict,
                                   dict]]] = dict(type='Xavier',
                                                  layer='Conv2d',
                                                  distribution='uniform')
    ) -> None:
        super().__init__(in_channels, out_channels, num_outs, start_level,
                         end_level, add_extra_convs, relu_before_extra_convs,
