...
class SEAttention(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv2 = ConvNormActivation(middle_channels,
                                        in_channels,
                                        1,
                                        1,
                                        bias=True,
...
class SpatialAttention(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv = ConvNormActivation(2,
                                       1,
                                       kernel_size,
                                       stride,
...
class ECAMAttention(BaseModule):
    ...
    def forward(self, inputs):
        ...
        x = self.conv(x.squeeze(-1).transpose(-1,
                                              -2)).transpose(-1,
                                                             -2).unsqueeze(-1)
        x = self.act(x)
...
class ECA(BaseModule):
    ...
    def __init__(self,
        ...
        self.avgPool = nn.AdaptiveAvgPool2d((1, 1))
        self.unfold = nn.Unfold(kernel_size=(1, kernel_size[1]),
