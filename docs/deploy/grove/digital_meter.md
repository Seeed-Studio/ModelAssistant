...
- Refer to [Training - YOLOv5 Models](../../tutorials/training/yolo.md) to train the YOLOv5 model and get the model weights using PyTorch and [SenseCraft Model Assistant](https://github.com/Seeed-Studio/SSCMA) by yourself.
