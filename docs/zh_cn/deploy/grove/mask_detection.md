...
本教程将基于 [SenseCraft Model Assistant](https://github.com/Seeed-Studio/SSCMA) 示范使用 Grove - Vision AI 模块实现口罩检测的开发流程。
...
- 参考[模型训练 - FOMO 模型](../../tutorials/training/fomo.md)，基于 PyTorch 和 [SenseCraft Model Assistant](https://github.com/Seeed-Studio/SSCMA) 自行训练 FOMO 模型得到模型权重。
