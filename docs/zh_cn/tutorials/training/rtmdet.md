...
在此我们以 `rtmdet_nano_8xb32_300e_coco_ncadc_relu6.py` 为例，展示如何使用 SSCMA 进行 RTMDet 模型训练。
...
- `configs/rtmdet/rtmdet_nano_8xb32_300e_coco_ncadc_relu6.py`: 指定配置文件，定义模型和训练设置。
