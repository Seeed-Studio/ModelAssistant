...
class Encode(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, tag):
        ...
        self.cluster = EuclidDistance_Assign_Module(feature_dim=out_channel * 4, cluster_num=2)
        self.sim_cluster = Space_EuclidDistance_Assign_Module(feature_dim=3, cluster_num=2, soft_assign_alpha=4096)
...
class Vae_Encode(nn.Module):
    ...
    def __init__(self, x_size, in_channel, out_channel, tag):
        ...
        self.cluster2 = EuclidDistance_Assign_Module(feature_dim=latent_dim, cluster_num=16, soft_assign_alpha=5)
