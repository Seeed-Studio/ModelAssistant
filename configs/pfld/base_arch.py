...
model = dict(
    type='PFLD',
    backbone=dict(type='MobileNetv2', widen_factor=0.35, out_indices=(5,), rep=True),
    head=dict(type='PFLDhead', num_point=num_classes, input_channel=56, act_cfg='ReLU', loss_cfg=dict(type='PFLDLoss')),
)
