...
# -----data related-----
data_root = '/home/dq/datasets/coco/'  # Root path of data
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(
        type='SGD', lr=base_lr, momentum=0.937, weight_decay=weight_decay, nesterov=True, batch_size_per_gpu=batch_size
    ),
