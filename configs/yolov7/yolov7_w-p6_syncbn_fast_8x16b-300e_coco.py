...
batch_shapes_cfg = dict(
    img_size=imgsz[0], size_divisor=64  # The image scale of padding should be divided by pad_size_divisor
...
val_dataloader = dict(dataset=dict(pipeline=test_pipeline, batch_shapes_cfg=batch_shapes_cfg))
...
tta_pipeline = [
    ...
    dict(
        ...
        transforms=[
            _multiscale_resize_transforms,
            [dict(type='mmdet.RandomFlip', prob=1.0), dict(type='mmdet.RandomFlip', prob=0.0)],
