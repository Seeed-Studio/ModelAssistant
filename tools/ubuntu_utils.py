...
def ensure_base_env(work_dir, dep_dir):
    ...
    * mmcv (not compulsory)
    ...
    #dep
    os.system(
        f"{sudo} apt-get install cmake make curl wget git inetutils-ping libgtk2.0-dev pkg-config libavcodec-dev libavformat-dev libswscale-dev python3-dev pciutils -y"
    )
