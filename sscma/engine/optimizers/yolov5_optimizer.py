...
from sscma.registry import OPTIM_WRAPPER_CONSTRUCTORS, OPTIM_WRAPPERS, OPTIMIZERS
...
class YOLOv5OptimizerConstructor:
    ...
    def __call__(self, model: nn.Module) -> OptimWrapper:
        ...
        # conv
        optimizer_cfg['params'].append({'params': params_groups[0], 'weight_decay': weight_decay})
        # bn
        ...
        optim_wrapper = OPTIM_WRAPPERS.build(self.optim_wrapper_cfg, default_args=dict(optimizer=optimizer))
