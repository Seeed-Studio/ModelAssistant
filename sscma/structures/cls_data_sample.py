...
class ClsDataSample(BaseDataElement):
    ...
    def set_gt_label(self, value: Union[np.ndarray, torch.Tensor, Sequence[Number], Number]) -> 'ClsDataSample':
    ...
    def set_gt_score(self, value: torch.Tensor) -> 'ClsDataSample':
        ...
        if hasattr(self, 'num_classes'):
            ...
            self.set_field(name='num_classes', value=len(label_data.score), field_type='metainfo')
        self.gt_label = label_data
        return self

    def set_pred_label(self, value: Union[np.ndarray, torch.Tensor, Sequence[Number], Number]) -> 'ClsDataSample':
