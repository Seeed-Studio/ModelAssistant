...
class BaseInstanceMasks(metaclass=ABCMeta):
    ...
    def rescale(self, scale, interpolation="nearest"):
        ...
        For details can refer to `simplecv_imrescale`.

        Args:
            scale (tuple[int]): The maximum size (h, w) of rescaled mask.
            interpolation (str): Same as :func:`simplecv_imrescale`.
    ...
    def resize(self, out_shape, interpolation="nearest"):
        ...
        Args:
            ...
            interpolation (str): See :func:`simplecv_imresize`.
    ...
    def crop_and_resize(
        ...
        Args:
            ...
            interpolation (str): See `simplecv_imresize`
    ...
    def translate(
        ...
        Args:
            ...
            interpolation (str): Same as :func:`simplecv_imtranslate`.
    ...
    def shear(
        ...
        Args:
            ...
            interpolation (str): Same as in :func:`simplecv_imshear`.
...
class BitmapMasks(BaseInstanceMasks):
    ...
    def rescale(self, scale, interpolation="nearest"):
        ...
        if len(self.masks) == 0:
            new_w, new_h = simplecv_rescale_size((self.width, self.height), scale)
            rescaled_masks = np.empty((0, new_h, new_w), dtype=np.uint8)
        else:
            rescaled_masks = np.stack(
                [
                    simplecv_imrescale(mask, scale, interpolation=interpolation)
    ...
    def flip(self, flip_direction="horizontal"):
        ...
        if len(self.masks) == 0:
            ...
            flipped_masks = np.stack(
                [simplecv_imflip(mask, direction=flip_direction) for mask in self.masks]
            )
    ...
    def pad(self, out_shape, pad_val=0):
        ...
        if len(self.masks) == 0:
            ...
            padded_masks = np.stack(
                [
                    simplecv_impad(mask, shape=out_shape, pad_val=pad_val)
                    for mask in self.masks
                ]
            )
    ...
    def translate(
        ...
        if len(self.masks) == 0:
            ...
            if masks.shape[-2:] != out_shape:
                ...
                masks = empty_masks
            translated_masks = simplecv_imtranslate(
    ...
    def shear(
        ...
        if len(self.masks) == 0:
            ...
            sheared_masks = simplecv_imshear(
    ...
    def rotate(
        ...
        Args:
            ...
            scale (int | float): Isotropic scale factor.
            border_value (int | float): Border value. Default 0 for masks.
            interpolation (str): Same as in :func:`simplecv_imrotate`.
        ...
        if len(self.masks) == 0:
            ...
            rotated_masks = simplecv_imrotate(
                self.masks.transpose((1, 2, 0)),
                angle,
                center=center,
                scale=scale,
