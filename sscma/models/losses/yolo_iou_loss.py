...
class YOLOv5IoULoss(nn.Module):
    ...
    This is the 2.0.0-branch unified IoU loss used by YOLOV5Head
    (xywh-friendly, ciou/siou/giou, optionally returns the IoU itself).
    It is separate from the mmdet-2.x-style :class:`IoULoss` in
    ``iou_loss.py`` which has a different signature.
