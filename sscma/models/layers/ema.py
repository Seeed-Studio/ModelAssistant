...
class ExpMomentumEMA(MMDET_ExpMomentumEMA):
    ...
    def __init__(
        ...
        super().__init__(
            model=model, momentum=momentum, interval=interval, device=device, update_buffers=update_buffers
        )
        ...
        self.src_parameters = model.state_dict() if self.update_buffers else dict(model.named_parameters())
